...
package uwu.smsgamer.PasteClient.AltManager.GUI;
...
import uwu.smsgamer.PasteClient.AltManager.AltLoginThread;
import uwu.smsgamer.PasteClient.AltManager.AltManager;
import uwu.smsgamer.PasteClient.ClientBase;
import uwu.smsgamer.PasteClient.utils.R2DUtils;
...
public class GuiAltManager extends GuiScreen {
    ...
    public void actionPerformed(final GuiButton button) throws IOException {
        switch (button.id) {
            ...
            case 5: {
                final AltManager altManager2 = ClientBase.INSTANCE.altManager;
                ...
                final AltManager altManager3 = ClientBase.INSTANCE.altManager;
            ...
            case 7: {
                final AltManager altManager4 = ClientBase.INSTANCE.altManager;
            ...
            case 8: {
                ...
                try {
                    ClientBase.INSTANCE.fileManager.loadAlts();
                } catch (Exception e3) {
                    e3.printStackTrace();
                }
    ...
    public void drawScreen(final int par1, final int par2, final float par3) {
        ...
        final AltManager altManager = ClientBase.INSTANCE.altManager;
        this.drawCenteredString(fontRendererObj, AltManager.registry.size() + " alts", this.width / 2, 10, -1);
