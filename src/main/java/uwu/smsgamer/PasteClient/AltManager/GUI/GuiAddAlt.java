...
public class GuiAddAlt extends GuiScreen
{
    ...
    private class AddAltThread extends Thread
    {
        ...
        public AddAltThread(final String username, final String password) {
            ...
            GuiAddAlt.access$0(GuiAddAlt.this,  "Idle...");
        }
        ...
        private final void checkAndAddAlt(final String username, final String password) throws IOException {
            ...
            try {
                ...
                GuiAddAlt.access$0(GuiAddAlt.this, "Alt failed!");
                e2.printStackTrace();
            }
        }
        ...
        public void run() {
            if (this.password.equals("")) {
                ...
                GuiAddAlt.access$0(GuiAddAlt.this, "Alt added. (" + this.username + " - offline name)");
                return;
            }
            GuiAddAlt.access$0(GuiAddAlt.this, "Trying alt...");
            try {
