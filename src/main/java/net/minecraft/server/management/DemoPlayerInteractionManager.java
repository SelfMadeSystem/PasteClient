...
public class DemoPlayerInteractionManager extends PlayerInteractionManager
{
    ...
    public void updateBlockRemoving()
    {
        ...
        if (i % 24000L == 500L)
        {
            if (j <= 6L)
            {
                this.thisPlayerMP.addChatMessage(new TextComponentTranslation("demo.day." + j));
            }
        }
        else if (j == 1L)
        {
        ...
        {
            this.thisPlayerMP.addChatMessage(new TextComponentTranslation("demo.day.warning"));
        }
    }
    ...
    private void sendDemoReminder()
    {
        ...
        {
            this.thisPlayerMP.addChatMessage(new TextComponentTranslation("demo.reminder"));
