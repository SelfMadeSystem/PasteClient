...
public class MovementStep implements ITutorialStep
{
    ...
    private static final ITextComponent field_193256_c = new TextComponentTranslation("tutorial.look.title");
    private static final ITextComponent field_193257_d = new TextComponentTranslation("tutorial.look.description");
