...
import uwu.smsgamer.PasteClient.AltManager.GUI.GuiAltManager;
...
public class GuiMainMenu extends GuiScreen {
    ...
    private void addSingleplayerMultiplayerButtons(int p_73969_1_, int p_73969_2_) {
        ...
        this.buttonList.add(new GuiButton(666, this.width / 2 - 100, p_73969_1_ + p_73969_2_ * 2, I18n.format("Alt Manager")));
    ...
    private void drawBackground() {
        final ScaledResolution var22 = new ScaledResolution(this.mc);
        ...
        GlStateManager.color(1.0f, 1.0f, 1.0f, 1.0f);
        GlStateManager.disableAlpha();
        this.mc.getTextureManager().bindTexture(new ResourceLocation("textures/gui/title/background/bg.png"));
        final Tessellator var23 = Tessellator.getInstance();
        final BufferBuilder var24 = var23.getBuffer();
        var24.begin(7, DefaultVertexFormats.POSITION_TEX_COLOR);
        ...
        var24.pos(-90.0, 0.0, 1.0).tex(0.0, sh);
        var24.pos(-90.0, 1.0, 1.0).tex(sw, sh);
        var24.pos(-90.0, 1.0, 0.0).tex(sw, 0.0);
        var24.pos(-90.0, 0.0, 0.0).tex(0.0, 0.0);
        var23.draw();
        GlStateManager.depthMask(true);
        GlStateManager.enableDepth();
        GlStateManager.enableAlpha();
