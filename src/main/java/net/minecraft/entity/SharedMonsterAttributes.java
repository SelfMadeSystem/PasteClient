...
public class SharedMonsterAttributes
{
    ...
    public static final IAttribute field_193334_e = (new RangedAttribute(null, "generic.flyingSpeed", 0.4000000059604645D, 0.0D, 1024.0D)).setDescription("Flying Speed").setShouldWatch(true);
