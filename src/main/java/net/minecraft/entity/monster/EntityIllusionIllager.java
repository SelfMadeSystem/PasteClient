        ...
        if (this.world.isRemote && this.isInvisible())
        {
            ...
            else
            {
                ...
                for (int j = 0; j < 4; ++j)
                {
                    ...
                    this.field_193100_bx[1][j] = new Vec3d((double)(-6.0F + (float)this.rand.nextInt(13)) * 0.5D, Math.max(0, this.rand.nextInt(6) - 4), (double)(-6.0F + (float)this.rand.nextInt(13)) * 0.5D);
                }
